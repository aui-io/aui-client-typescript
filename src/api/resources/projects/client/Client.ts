...
export class Projects {
    ...
    ): core.HttpResponsePromise<Apollo.PageProject> {
    ...
    private async __listProjects(
        request: Apollo.ListProjectsRequest = {},
        requestOptions?: Projects.RequestOptions,
    ): Promise<core.WithRawResponse<Apollo.PageProject>> {
        const {
            "page[size]": pageSize,
        ...
        if (_response.ok) {
            return { data: _response.body as Apollo.PageProject, rawResponse: _response.rawResponse };
        }
