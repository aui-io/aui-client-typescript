...
export class ExternalSessionSocket {
    public readonly socket: core.ReconnectingWebSocket;
    protected readonly eventHandlers: ExternalSessionSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        this.eventHandlers.message?.(data as ExternalSessionSocket.Response);
    };
    ...
    constructor(args: ExternalSessionSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof ExternalSessionSocket.EventHandlers>(
        event: T,
        callback: ExternalSessionSocket.EventHandlers[T],
    ): void {
    ...
    public connect(): ExternalSessionSocket {
