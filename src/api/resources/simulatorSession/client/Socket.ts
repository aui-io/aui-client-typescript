...
export class SimulatorSessionSocket {
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        this.eventHandlers.message?.(data as SimulatorSessionSocket.Response);
    };
     ...
     * ```
     */
    public on<T extends keyof SimulatorSessionSocket.EventHandlers>(
        event: T,
        callback: SimulatorSessionSocket.EventHandlers[T],
    ): void {
        this.eventHandlers[event] = callback;
    }

    public sendSimulatorCommand(message: Apollo.SimulatorCommand): void {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }

    /** Connect to the websocket and register event handlers. */
    public connect(): SimulatorSessionSocket {
