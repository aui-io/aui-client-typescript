...
export declare namespace SessionSocket {
...
export class SessionSocket {
    ...
    protected readonly eventHandlers: SessionSocket.EventHandlers = {};
    ...
    private handleMessage: (event: { data: string }) => void = (event) => {
        ...
        this.eventHandlers.message?.(data as SessionSocket.Response);
    };
    ...
    constructor(args: SessionSocket.Args) {
     ...
     * ```
     */
    public on<T extends keyof SessionSocket.EventHandlers>(event: T, callback: SessionSocket.EventHandlers[T]): void {
